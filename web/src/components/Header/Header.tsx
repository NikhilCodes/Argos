  ...
  return (
    ...
    >
      ...
      <div className={'flex gap-2 items-center relative'}>
        <div className={'w-20'}/>
        <div
          className={twMerge('flex items-center left-0 absolute text-xs rounded-full px-2 py-0.5 border-1 border-solid border-emerald-500 text-black transition', !connected && 'opacity-0 translate-y-5')}
        >
          <div className={'me-1 inline-flex h-2 w-2 rounded-full bg-emerald-500 opacity-75'}/>
          Online
        </div>
        <div
          className={twMerge('flex items-center absolute text-xs rounded-full px-2 py-0.5 border-1 border-solid border-red-700 text-black transition', connected && 'opacity-0 -translate-y-5')}
        >
